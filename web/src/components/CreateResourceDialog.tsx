...
const fileTypeAutocompleteOptions = ["image/*", "text/*", "audio/*", "audio/mp3", "video/*", "video/mp4", "application/*"];
        ...
        <>
            ...
            <div className="dialog-content-container !w-80">
                ...
                {state.selectedMode === "local-file" && (
                    <>
                        <div
                            className="w-full relative bg-blue-50 dark:bg-zinc-900 rounded-md flex flex-row justify-center items-center py-8">
                            <label htmlFor="files"
                                   className="p-2 px-4 text-sm text-white cursor-pointer bg-blue-500 block rounded hover:opacity-80">
                ...
                <div className="mt-2 w-full flex flex-row justify-end items-center space-x-1">
                    ...
                    <Button onClick={handleConfirmBtnClick} loading={state.uploadingFlag}
